## This function inverse a matrix only if one was not inversed and saved before
## functions create a special matrix and inverse it (if one was not saved in the cache before)
